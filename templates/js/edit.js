$( document ).ready( function ()
{
    ...
    $('.startHour').on('change', function(){
        ...
        var curStartMin = parseInt($('.startMin option:selected' ).val());
        var curEndHour = parseInt($('.endHour option:selected' ).val());
        var curEndMin = parseInt($('.endMin option:selected' ).val());
        checkUpdate(new Date(year, month, day, curStartHour, curStartMin),
            new Date(year, month, day, curEndHour, curEndMin));
    })
